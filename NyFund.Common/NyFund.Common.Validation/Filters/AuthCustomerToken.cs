...
{
    public class AuthCustomerToken : ActionFilterAttribute
    {
        private readonly ITokenService _tokenService;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public AuthCustomerToken(ITokenService tokenService,
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            var authDto = _tokenService.GetAuthCustomer(id);
            ...
            CustomerSession.SetSession(authDto.Result);
            CustomerSession.Id = authDto.Result.Id;
            context.HttpContext.Items.Add("CustomerSession", authDto.Result);
        }
    }
}
*/